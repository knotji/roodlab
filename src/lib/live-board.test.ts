...
describe("live board",()=>{
  ...
  it("omits weekday market results on Bangkok weekends",()=>{const market={id:"nikkei-morning",name:"หุ้นนิเคอิเช้า",slug:"nikkei-morning",category:"หุ้น",sourceUrl:"https://example.com/market"};expect(buildLiveBoard([market],{},new Date("2026-09-05T02:00:00Z"))).toEqual([]);expect(buildLiveBoard([market],{},new Date("2026-09-07T02:00:00Z"))).toHaveLength(1)});
});
